...
class ExcLqa(nn.Module):
    ...
    """
    def __init__(self, couplings_bin, fields_bin, identity, qubits, qudits, a):
        super(ExcLqa, self).__init__()
    ...
    def energy_ising(self, config):
        ...
        energy = energy_1 + self.a / energy_1
    ...
    def minimise(self,
        ...
        state. The final configuration corresponds to the first excited state of the problem Hamiltonian.
            * step: learning rate
            * N: number of steps
